  ...
  return (
    <>
      <section
        ...
        className={`overflow-y-hidden card mt-12 sm:mt-16 md:mt-[100px] px-6 py-4 md:py-10 lg:py-12 flex flex-col lg:items-center lg:flex-row justify-between rounded-2xl bg-gradient-to-r from-[#00000080] to-[#1a1a1a80]`}
      >
        {!formDisplay ? (
          <div
            className={` ${
                ...
                >
                  <div className="flex gap-1 flex-col">
                    ...
                    <input
                      ...
                      className="bg-transparent rounded-md border border-[#4a4a4a] focus:border-[#666666] outline-none py-1 pl-2"
                    />
                    {errors?.userName && (
                  ...
                  <button
                    className={`rounded-md bg-gradient-to-r from-[#00000080] to-[#1a1a1a80] py-3 px-5 ${syne.className} font-bold uppercase mt-4 hover:from-[#000000] hover:to-[#1a1a1a] transition-all duration-300`}
                  >
                    Send
                  </button>
                </form>
